...
_G.AimPart = "Torso" -- What body part of the closest enemy the aimbot script would lock at.
_G.Sensitivity = 3 -- How many seconds it takes for the aimbot script to officially lock onto the target's aimpart.
...
_G.FlyEnabled = true -- Determines if fly is enabled